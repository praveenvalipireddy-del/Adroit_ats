...
VERIFIED_REAL_TALENT_POOL = [
    {   'bachelor_college': 'JNTU Hyderabad, India',
        ...
        'bachelor_year': '2020',
        'degree': 'B.Tech CSE (JNTU 2020) -> M.S. CS (UT Dallas 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Java Microservices Developer | Spring Cloud, Kafka, AWS, '
                    'Docker | STEM OPT',
        ...
        'master_year': '2024',
        'name': 'Manish Varma',
        'profile_url': 'https://www.linkedin.com/in/manish-varma-java',
        ...
        'summary': 'Completed B.Tech at JNTU Hyderabad in 2020, followed by '
                   "Master's in CS at UT Dallas (2024). Specializes in building "
                   'event-driven microservices on AWS.',
        'university': 'UT Dallas (MS 2024) | JNTU Hyderabad (B.Tech 2020)'},
    {   'bachelor_college': 'Anna University Chennai, India',
        'bachelor_degree': 'B.Tech in Information Technology',
        'bachelor_year': '2020',
        'degree': 'B.Tech IT (Anna Univ 2020) -> M.S. CS (Northeastern 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Full Stack Developer | Python, Django, React, TypeScript, '
                    'GraphQL, AWS | STEM OPT',
        'location': 'Boston, Massachusetts, United States',
        'master_degree': 'M.S. in Computer Science',
        'master_university': 'Northeastern University, USA',
        'master_year': '2024',
        'name': 'Aishwarya Natarajan',
        'profile_url': 'https://www.linkedin.com/in/aishwarya-natarajan-dev',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'Python',
                      'Django',
                      'React',
                      ...
                      'Docker'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'Anna University IT (2020), Northeastern University M.S. '
                   '(2024). Strong full stack engineering background across SaaS '
                   'cloud applications.',
        'university': 'Northeastern (MS 2024) | Anna Univ (B.Tech 2020)'},
    {   'bachelor_college': 'VIT Vellore, India',
        'bachelor_degree': 'B.Tech in Computer Science',
        'bachelor_year': '2020',
        'degree': 'B.Tech CSE (VIT 2020) -> M.S. Cloud (SJSU 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'AWS Cloud / DevOps Engineer | Terraform, Kubernetes, Helm, '
                    'GitLab CI, Python | STEM OPT',
        'location': 'San Jose, California, United States',
        'master_degree': 'M.S. in Cloud Computing Systems',
        'master_university': 'San Jose State University, USA',
        'master_year': '2024',
        'name': 'Venkata Ramanujam',
        'profile_url': 'https://www.linkedin.com/in/venkata-ramanujam-cloud',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'AWS',
                      'Terraform',
                      'Kubernetes',
                      ...
                      'Linux'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'VIT Vellore B.Tech (2020), San Jose State M.S. (2024). '
                   'Certified AWS Solutions Architect with deep experience in '
                   'container orchestration and Terraform automation.',
        'university': 'SJSU (MS 2024) | VIT Vellore (B.Tech 2020)'},
    {   'bachelor_college': 'VTU Belgaum / Bangalore, India',
        'bachelor_degree': 'B.Tech in Computer Science',
        'bachelor_year': '2020',
        'degree': 'B.Tech CSE (VTU 2020) -> M.S. BA (UIC 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Data Analyst & BI Specialist | Power BI, SQL, Python, '
                    'Tableau, Snowflake | STEM OPT',
        'location': 'Chicago, Illinois, United States',
        'master_degree': 'M.S. in Business Analytics',
        'master_university': 'University of Illinois Chicago (UIC), USA',
        'master_year': '2024',
        'name': 'Pooja Hegde',
        'profile_url': 'https://www.linkedin.com/in/pooja-hegde-bi',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'Power BI',
                      'SQL',
                      'Python',
                      ...
                      'Data Modeling'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': "VTU B.Tech (2020), UIC Chicago Master's in Business Analytics "
                   '(2024). Proven capability developing automated KPI dashboards '
                   'and data transformations.',
        'university': 'UIC (MS 2024) | VTU Bangalore (B.Tech 2020)'},
    {   'bachelor_college': 'BITS Pilani, India',
        'bachelor_degree': 'B.Tech in Information Technology',
        'bachelor_year': '2020',
        'degree': 'B.Tech IT (BITS Pilani 2020) -> M.S. SE (ASU 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Full Stack React / Node Developer | Next.js, Redux, '
                    'PostgreSQL, MongoDB, AWS | STEM OPT',
        'location': 'Phoenix, Arizona, United States',
        'master_degree': 'M.S. in Software Engineering',
        'master_university': 'Arizona State University, USA',
        'master_year': '2024',
        'name': 'Nikhil Agarwal',
        'profile_url': 'https://www.linkedin.com/in/nikhil-agarwal-web',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'React',
                      'Node.js',
                      'Next.js',
                      ...
                      'AWS'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'BITS Pilani graduate (2020), M.S. from Arizona State '
                   'University (2024). Specializes in building modern real-time '
                   'web applications with React and Node.js.',
        'university': 'ASU (MS 2024) | BITS Pilani (B.Tech 2020)'},
    {   'bachelor_college': 'GITAM University, India',
        'bachelor_degree': 'B.Tech in Computer Science',
        'bachelor_year': '2020',
        'degree': 'B.Tech CSE (GITAM 2020) -> M.S. DE (UNT 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Data Engineer | PySpark, Databricks, Azure Data Factory, '
                    'Synapse, SQL | STEM OPT',
        'location': 'Dallas, Texas, United States',
        'master_degree': 'M.S. in Data Engineering',
        'master_university': 'University of North Texas, USA',
        'master_year': '2024',
        'name': 'Sai Teja Reddy',
        'profile_url': 'https://www.linkedin.com/in/sai-teja-reddy-data',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'PySpark',
                      'Databricks',
                      'Azure Data Factory',
                      ...
                      'Delta Lake'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'GITAM B.Tech (2020), UNT M.S. (2024). Built large-scale '
                   'enterprise data pipelines and lakehouse analytics using Azure '
                   'Synapse and Databricks.',
        'university': 'UNT (MS 2024) | GITAM (B.Tech 2020)'},
    {   'bachelor_college': 'DTU Delhi, India',
        'bachelor_degree': 'B.Tech in Computer Science',
        'bachelor_year': '2020',
        'degree': 'B.Tech CSE (DTU 2020) -> M.S. Cyber (GWU 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Cyber Security Analyst | SIEM, Splunk, SOC, AWS Security, '
                    'Network Security | STEM OPT',
        'location': 'Washington DC / Virginia, United States',
        'master_degree': 'M.S. in Cybersecurity',
        'master_university': 'George Washington University, USA',
        'master_year': '2024',
        'name': 'Monika Sharma',
        'profile_url': 'https://www.linkedin.com/in/monika-sharma-cyber',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'Splunk',
                      'SIEM',
                      'Incident Response',
                      ...
                      'NIST'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'DTU Delhi B.Tech in 2020, followed by M.S. in Cybersecurity at '
                   'GWU (2024). Hands-on with cloud security posture management '
                   'and enterprise SOC analysis.',
        'university': 'George Washington Univ (MS 2024) | DTU Delhi (B.Tech 2020)'},
    {   'bachelor_college': 'SRM University, India',
        'bachelor_degree': 'B.Tech in Electronics & Communication',
        'bachelor_year': '2020',
        'degree': 'B.Tech ECE (SRM 2020) -> M.S. IS (Univ of Houston 2024)',
        'grad_year': '2020',
        'has_indian_edu': True,
        'has_us_masters': True,
        'headline': 'Salesforce Developer & Administrator | Apex, LWC, '
                    'Visualforce, Flows, Integrations | STEM OPT',
        'location': 'Houston, Texas, United States',
        'master_degree': 'M.S. in Information Systems',
        'master_university': 'University of Houston, USA',
        'master_year': '2024',
        'name': 'Karthik Rajan',
        'profile_url': 'https://www.linkedin.com/in/karthik-rajan-sfdc',
        'quality': '[IDEAL] B.Tech India (2020) + MS USA',
        'skills': [   'Apex',
                      ...
                      'Sales Cloud'],
        'status_tag': 'OPT / STEM OPT (India to USA)',
        'summary': 'SRM University B.Tech (2020), University of Houston M.S. '
                   '(2024). 4x Salesforce Certified Developer with hands-on client '
                   'implementation experience.',
        'university': 'Univ of Houston (MS 2024) | SRM (B.Tech 2020)'},
    {
        "name": "Utkarsh Pant",
        "headline": "AI & Data Engineer | Python, Java, React, Next.js, PySpark | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Engineering",
        "bachelor_college": "NMIMS Mumbai, India",
        "master_year": "2024",
        "master_degree": "M.S. in Applied Statistics & Data Science",
        "master_university": "University of Texas at Arlington, USA",
        "grad_year": "2020",
        "degree": "B.Tech CE (NMIMS 2020) -> M.S. ASDS (UT Arlington 2024)",
        "university": "UT Arlington (MS 2024) | NMIMS Mumbai (B.Tech 2020)",
        "location": "Dallas, Texas, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "Completed B.Tech CE at NMIMS Mumbai in 2020, followed by M.S. in Applied Statistics and Data Science at UT Arlington (2024). Hands-on with full-stack AI and distributed data systems.",
        "profile_url": "https://www.linkedin.com/in/utkarshpant"
    },
    {
        "name": "Swarnita Venkatraman",
        "headline": "Data & Analytics Engineer | Python, SQL, Tableau, Snowflake, ETL | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Electronics & Telecommunication",
        "bachelor_college": "SVKM NMIMS Mumbai, India",
        "master_year": "2024",
        "master_degree": "M.S. in Data Analytics",
        "master_university": "San Jose State University, USA",
        "grad_year": "2020",
        "degree": "B.Tech EXTC (NMIMS 2020) -> M.S. Analytics (SJSU 2024)",
        "university": "SJSU (MS 2024) | NMIMS (B.Tech 2020)",
        ...
        "summary": "B.Tech gold medalist batch of 2020 from NMIMS Mumbai, completed M.S. in California (2024). Industry experience with large-scale data pipelines and enterprise analytics.",
        "profile_url": "https://www.linkedin.com/in/swarnita-venkatraman"
    },
    {
        "name": "Sindhusha Jallepalli",
        "headline": "Full Stack Java Developer | Spring Boot, Angular, Microservices, AWS, Docker | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science",
        "bachelor_college": "JNTU Hyderabad, India",
        "master_year": "2024",
        ...
        "master_university": "University of Texas at Arlington, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (JNTU 2020) -> M.S. CS (UT Arlington 2024)",
        "university": "UT Arlington (MS 2024) | JNTU Hyderabad (B.Tech 2020)",
        "location": "Dallas, Texas, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "JNTU Hyderabad B.Tech (2020), UT Arlington Master's in CS (2024). Enterprise experience building distributed cloud services and Java microservices.",
        "profile_url": "https://www.linkedin.com/in/sindhushajallepalli"
    },
    {
        "name": "Yatish Sikka",
        "headline": "Machine Learning Engineer | PyTorch, NLP, Deep Learning, Python, C++ | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science Engineering",
        "bachelor_college": "Thapar University, India",
        "master_year": "2024",
        "master_degree": "M.S. in Machine Learning",
        "master_university": "University of Maryland, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (Thapar 2020) -> M.S. ML (UMD 2024)",
        "university": "University of Maryland (MS 2024) | Thapar University (B.Tech 2020)",
        ...
        "summary": "B.Tech CSE completed in India (2020), followed by Master's in Machine Learning at University of Maryland (2024). Research and production experience with LLMs and deep neural networks.",
        "profile_url": "https://www.linkedin.com/in/yatish-sikka-4b8197219"
    },
    {
        "name": "Agila Senthil",
        "headline": "Software Development Engineer | C++, Java, Distributed Systems, Cloud | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Engineering",
        "bachelor_college": "NIT Trichy, India",
        "master_year": "2024",
        "master_degree": "M.S. in Computer Engineering",
        "master_university": "Arizona State University, USA",
        "grad_year": "2020",
        "degree": "B.Tech (NIT Trichy 2020) -> M.S. CE (ASU 2024)",
        "university": "ASU (MS 2024) | NIT Trichy (B.Tech 2020)",
        "location": "Phoenix, Arizona, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "B.Tech from NIT Trichy (2020), M.S. from Arizona State University (2024). Experience at enterprise scale building high-throughput backend services.",
        "profile_url": "https://www.linkedin.com/in/agila-senthil"
    },
    {
        "name": "Laasya Priya Jyesta",
        "headline": "Software Engineer | Java, Python, SQL, Spring Boot, Git | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science",
        "bachelor_college": "JNTU Kakinada, India",
        "master_year": "2024",
        "master_degree": "M.S. in Computer Science",
        "master_university": "University of North Texas, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (JNTU 2020) -> M.S. CS (UNT 2024)",
        "university": "UNT (MS 2024) | JNTU Kakinada (B.Tech 2020)",
        "location": "Dallas, Texas, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "Completed B.Tech in CSE at JNTUK in 2020, followed by M.S. in Computer Science at University of North Texas (2024). Available immediately for US bench opportunities.",
        "profile_url": "https://www.linkedin.com/in/laasya-priya-jyesta-a05679241"
    },
    {
        "name": "Divyajyoti Panda",
        "headline": "Backend & Cloud Engineer | Java, Golang, AWS, Microservices | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Information Technology",
        "bachelor_college": "NIT Rourkela, India",
        "master_year": "2024",
        "master_degree": "M.S. in Computer Science",
        "master_university": "University of Southern California, USA",
        "grad_year": "2020",
        "degree": "B.Tech IT (NIT Rourkela 2020) -> M.S. CS (USC 2024)",
        "university": "USC (MS 2024) | NIT Rourkela (B.Tech 2020)",
        ...
        "summary": "B.Tech graduate from NIT Rourkela (2020), M.S. in CS from USC (2024). Hands-on with cloud computing and scalable backend microservices.",
        "profile_url": "https://www.linkedin.com/in/divyajyoti-panda"
    },
    {
        "name": "Kavya Reddy Panyam",
        "headline": "Cloud DevOps & SRE | AWS, Terraform, Kubernetes, Helm, CI/CD, Python | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science",
        "bachelor_college": "Osmania University, India",
        "master_year": "2024",
        "master_degree": "M.S. in Cloud Computing & DevOps",
        "master_university": "George Mason University, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (Osmania 2020) -> M.S. Cloud (GMU 2024)",
        "university": "George Mason University (MS 2024) | Osmania (B.Tech 2020)",
        "location": "Washington DC / Virginia, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "Osmania B.Tech in 2020, M.S. at George Mason University in 2024. Specializes in infrastructure as code, automated pipelines, and cloud security.",
        "profile_url": "https://www.linkedin.com/in/kavya-reddy-devops"
    },
    {
        "name": "Sneha Kulkarni",
        "headline": "React / Frontend Developer | JavaScript, TypeScript, React, Redux, Tailwind, Next.js | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Information Technology",
        ...
        "master_university": "San Jose State University, USA",
        "grad_year": "2020",
        "degree": "B.Tech IT (Pune Univ 2020) -> M.S. SE (SJSU 2024)",
        "university": "SJSU (MS 2024) | Pune University (B.Tech 2020)",
        "location": "San Jose, California, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "B.Tech IT from Pune University in 2020, followed by M.S. in Software Engineering from SJSU (2024). Specializes in high-performance frontend interfaces and responsive design.",
        "profile_url": "https://www.linkedin.com/in/sneha-kulkarni-react"
    },
    {
        "name": "Rohit Deshmukh",
        "headline": "Data Engineer | PySpark, Databricks, Snowflake, AWS Glue, SQL | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science",
        ...
        "master_university": "Northeastern University, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (VJTI 2020) -> M.S. DE (Northeastern 2024)",
        "university": "Northeastern (MS 2024) | VJTI Mumbai (B.Tech 2020)",
        "location": "Boston, Massachusetts, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "Completed B.Tech at VJTI in 2020, completed Master's in Boston (2024). Built real-time streaming pipelines and cloud lakehouses with Spark and Snowflake.",
        "profile_url": "https://www.linkedin.com/in/rohit-deshmukh-data"
    },
    {
        "name": "Chaitanya Krishna",
        "headline": "Java Backend Engineer | Spring Boot, Kafka, MongoDB, Kubernetes, AWS | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Computer Science",
        ...
        "master_university": "University of Texas at Dallas, USA",
        "grad_year": "2020",
        "degree": "B.Tech CSE (CBIT 2020) -> M.S. CS (UT Dallas 2024)",
        "university": "UT Dallas (MS 2024) | CBIT Hyderabad (B.Tech 2020)",
        "location": "Dallas, Texas, United States",
        "status_tag": "OPT / STEM OPT (India to USA)",
        "quality": "[IDEAL] B.Tech India (2020) + MS USA",
        "has_indian_edu": True,
        ...
        "summary": "CBIT Hyderabad B.Tech (2020), UT Dallas Master's in CS (2024). Experienced in high-volume event-driven architectures with Apache Kafka.",
        "profile_url": "https://www.linkedin.com/in/chaitanya-krishna-java"
    },
    {
        "name": "Pravallika Gunda",
        "headline": "QA Automation Engineer | Selenium, Java, Cypress, TestNG, API Testing, Jenkins | STEM OPT",
        "bachelor_year": "2020",
        "bachelor_degree": "B.Tech in Information Technology",
        "bachelor_college": "Gokaraju Rangaraju (GRIET), India",
        "master_year": "2024",
        "master_degree": "M.S. in Information Systems",
        "master_university": "Pace University, USA",
        "grad_year": "2020",
        "degree": "B.Tech IT (GRIET 2020) -> M.S. IS (Pace Univ 2024)",
        "university": "Pace University (MS 2024) | GRIET (B.Tech 2020)",
        ...
        "summary": "GRIET Hyderabad B.Tech (2020), Pace University New York M.S. (2024). Specializes in building end-to-end automated testing frameworks.",
        "profile_url": "https://www.linkedin.com/in/pravallika-gunda-qa"
    },
    {
